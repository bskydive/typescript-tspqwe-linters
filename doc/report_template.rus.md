 ...
 * Граф зависимостей
	...
	* Циклические зависимости
		* 00% - 00 ошибок в 00 из 00 `*.ts` файлов, прирост +00%/00 файлов
 ...
 * выключить в [.eslitrc](https://github.com/bskydive/typescript-tspqwe-linters/blob/master/.eslintrc.js) неважные [типы ошибок](./log/eslint.rules.log)
