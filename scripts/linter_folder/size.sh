...
echo -e "`grep --include=\*\.{less,scss,css,ts,html} -Rl '' src/ | wc -l` all files" >> log/size.md
...
echo -e "`grep --include=\*.html -Rl '' src/ | wc -l` html files" >> log/size.md
...
echo -e "`grep --include=\*.less -Rl '' src/ | wc -l` less files" >> log/size.md
...
echo -e "`grep --include=\*.scss -Rl '' src/ | wc -l` scss files" >> log/size.md
...
echo -e "`grep --include=\*.css -Rl '' src/ | wc -l` css files" >> log/size.md
...
echo -e "`grep --include=\*.ts -Rl '' src/ | wc -l` ts files" >> log/size.md
