...
cat log/styles.log | grep '(' | awk -F'(' '{print $2}' | grep -E ')$'|tr -d ')' | sort | uniq > log/styles.rules.log
cat log/styles.rules.log > log/styles.rules.important.log
wc -l log/styles.rules.log >> log/styles.md

cat log/styles.log | awk -F' - ' '{print $2}' | sort | uniq > log/styles.short.log
wc -l log/styles.short.log >> log/styles.md

cat log/styles.log | grep ':' | awk -F':' '{print $1}' | sort | uniq > log/styles.files.log
